...
import xMen from '../../resourses/x-men.png';

const SingleComicPage = () => {
   const {comicId} = useParams();//вернет объект из ключа comicId и значения цифры (id)
...
const View = ({comic}) => {
   const {title, descr, pageCount, lang, price, thumbnail} = comic;
   return (
